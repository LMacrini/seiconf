{
  ...
  config.perSystem = {self', pkgs, ...}: let
    ...
    autogenerated = pkgs.writeText "flake.nix" ''
  ...
  in {
    ...
    packages.write-flake = pkgs.writeShellScriptBin "write-flake.sh" ''
      cp ${autogenerated} ./flake.nix
      chmod 644 ./flake.nix

      ${lib.getExe self'.formatter} ./flake.nix
    '';
  };
}
